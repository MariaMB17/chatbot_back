...
CREATE TABLE `Bots` (
    ...
    `namebot` VARCHAR(191) NOT NULL,
    `descriptcion` VARCHAR(191) NOT NULL,
    `model` VARCHAR(191) NOT NULL,
    `personality` VARCHAR(191) NOT NULL,
    `nicknamebot` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `Bots_namebot_key`(`namebot`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `knowledges` (
    ...
    UNIQUE INDEX `knowledges_description_key`(`description`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `knowledgeFiles` (
    ...
    `knowledgeBase_id` VARCHAR(191) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
