...
-- AddForeignKey
ALTER TABLE `knowledgenbots` ADD CONSTRAINT `knowledgenbots_knowledge_id_fkey` FOREIGN KEY (`knowledge_id`) REFERENCES `knowledges`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `memberonbots` ADD CONSTRAINT `memberonbots_member_id_fkey` FOREIGN KEY (`member_id`) REFERENCES `members`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `memberonbots` ADD CONSTRAINT `memberonbots_bot_id_fkey` FOREIGN KEY (`bot_id`) REFERENCES `bots`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `memberonknowledges` ADD CONSTRAINT `memberonknowledges_knowledge_id_fkey` FOREIGN KEY (`knowledge_id`) REFERENCES `knowledges`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
